import '../style/ContenedorPrincipalPagAdmin.css'
...
const ContenedorPrincipalPagAdmin = ({ vista = 'grilla', busqueda = '' }: { vista?: 'grilla' | 'lista', busqueda?: string }) => {
  ...
  return (
    <div className="main-container">
      ...
      <ProductosAdmin vista={vista} categoria={categoriaActiva} busqueda={busqueda} />
    </div>
  )
}

export default ContenedorPrincipalPagAdmin