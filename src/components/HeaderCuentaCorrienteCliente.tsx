...
import '../style/HeaderCuentaCorrienteCliente.css'
...
const HeaderCuentaCorrienteCliente = ({ onBuscar }: { onBuscar?: (termino: string) => void }) => {
  ...
  return (
    <>
        ...
        <nav className="nav-menu">
            <Link to="/TotalPedidosCliente" className="nav-item">
                <span className="nav-icon">📋</span>
                Pedidos
            </Link>
            <Link to="/CuentaCorrienteCliente" className="nav-item">
                <span className="nav-icon">💳</span>
                Cuenta Corriente
            </Link>
...
export default HeaderCuentaCorrienteCliente